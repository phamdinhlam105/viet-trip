...
export default function HotelItem({
  ...
  return (
    <div className="w-full flex flex-col justify-between bg-white rounded-lg border border-gray-200 space-y-4 pb-4 shadow-lg md:hover:scale-105  transition-all duration-500 ease-in-out">
      <Link href={`/hotel/${slug}`}>
        ...
        <div className="space-y-2 px-4 py-4">
          <h3 className="text-md font-bold line-clamp-2 min-h-12">{name}</h3>
