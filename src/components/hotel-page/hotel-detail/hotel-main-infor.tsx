...
export default function HotelMainInformation({ description, content, ultilities, roomDetails }: {
    description: string,
    content: string,
    ultilities: string,
    roomDetails: {
    ...
    return <div className="py-5">
        <div className="bg-gray-200 p-2 rounded-lg">
            ...
            <ul className="list-disc space-y-2 px-4">
                ...
                <li>
                    <p> <span className="font-semibold">Các tiện ích nổi bật: </span>{ultilities}</p>
                </li>
            </ul>
        ...
        <div className="py-5 px-2 space-y-4">
            ...
            <RoomPriceTable roomDetails={roomDetails} />
        </div>
        <div className="py-5 px-2 space-y-2 bg-gray-200 rounded-lg">
            <h2 className="text-center font-bold text-2xl">THÔNG TIN THÊM VỀ KHÁCH SẠN</h2>
            <div className="space-y-3" dangerouslySetInnerHTML={{ __html: content }} />
        </div>
    </div>
}