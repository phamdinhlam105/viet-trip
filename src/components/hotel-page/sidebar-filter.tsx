...
export default function HotelSideBar({
  ...
  return (
    <div className="py-4 space-y-4">
      <h2 className="text-xl font-bold bg-gradient-to-r from-[#1161A2] to-[#77C2B8] bg-clip-text text-transparent">
        BỘ LỌC TÌM KIẾM:
      </h2>
          ...
          <div className="space-y-2">
            {STARS.map((star) => (
              <button
                ...
                className={`flex items-center space-x-2 px-2 py-1 rounded w-full text-left transition ${
                  selectedStar === star
