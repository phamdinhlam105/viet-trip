...
const WHY_CHOOSE_US = [
  {
    ...
    content:
      "Chúng tôi là Công ty tổ chức và điều hành Tour du lịch trực tiếp Uy Tín và Chuyên Nghiệp tại Nha Trang.",
  },
  {
    id: 2,
    title: "Chuyên Tour Bình Ba",
    content:
      "Công ty lữ hành đầu tiên tổ chức Tour Bình Ba. Công ty trực tiếp tổ chức Tour Bình Ba Nha Trang chất lượng, uy tín nhất hiện nay.",
  },
  {
    id: 3,
    title: "Chất Lượng, Uy tín, Tận tình",
    content:
      "Đội ngũ nhân viên chuyên nghiệp, được đào tạo bài bản, tận tình, luôn sẵn sàng phục vụ Quý khách. Hệ thống tàu du lịch, cano đời mới, xe chất lượng cao, nhà bè trên đảo.",
  },
];
export default function WhyChooseUs() {
  return (
    ...
    >
      ...
      <div className="md:w-1/4 bg-white h-[4px]"></div>
