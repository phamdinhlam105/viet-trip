...
`
  ...
  <section class="content">
    ...
    <h4>Việt Nam có bến du thuyền quốc tế đầu tiên ở Nha Trang</h4>
    <p>"Đối với khách đi theo đoàn, giá thuê chuyến du thuyền khoảng từ 50 triệu đồng cho số lượng khoảng 50 người" – ông Tiệp thông tin.</p>
    <p>Ông Tiệp cũng cho hay hiện du khách Nga, Hàn Quốc rất chuộng sử dụng dịch vụ du thuyền. Còn du khách nội địa chọn loại hình này thường là những người trẻ, các gia đình ưa thích khi vừa có thể ghi lại những khoảnh khắc đẹp, vừa thư giãn với hành trình không quá ồn ào, vội vã.</p>
    ...
    <p>Nhiều du thuyền được thiết kế với khu vực nghỉ ngơi ngoài trời, ghế tắm nắng, quầy bar, phòng ăn và khu vực giải trí. Một số cung cấp bữa ăn hải sản, biểu diễn âm nhạc, spa ngay trên thuyền, cùng các dịch vụ như chèo SUP, snorkeling, mô tô nước…</p>

    <p>Trên du thuyền, du khách có thể thoải mái di chuyển, chụp ảnh, hoặc đơn giản chỉ ngồi tĩnh lặng nhìn sóng nước, ngắm toàn cảnh vịnh biển.</p>

    <p>Theo ông <strong>Nguyễn Quang Thắng</strong> – Phó chủ tịch thường trực Hiệp hội Du lịch Nha Trang – Khánh Hòa, lượng khách đặt tour du thuyền tăng đều, đặc biệt vào mùa cao điểm hè, thời tiết thuận lợi. Loại hình này không chỉ thu hút khách quốc tế mà còn nội địa, những người tìm kiếm sự riêng tư, thoải mái và trải nghiệm mới lạ.</p>
